...
## V 0.17 // Changelog Update &nbsp; `2021-10-__ __:__`
### Added
...
- Edited v0.7 changelog entry
  - *#fixedn't "Players do not despawn on death due to the fact..."* -> *#bugs*
- Edited v0.0 changelog entry
  - Removed patch version number from update header
  - *"Created repository"* -> *#added*
